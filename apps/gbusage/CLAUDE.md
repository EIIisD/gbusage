# CLAUDE.md - gbusage Package

This is the main gbusage CLI package that provides usage analysis for Claude Code.
...
This package contains the core gbusage functionality:
...
Because `gbusage` is distributed as a bundled CLI, keep all runtime libraries in `devDependencies` so the bundler captures them.
