import type { UsageReportConfig } from '@gbusage/terminal/table';
import process from 'node:process';
import { addEmptySeparatorRow, createUsageReportTable, formatTotalsRow, formatUsageDataRow, pushBreakdownRows } from '@gbusage/terminal/table';
...
export const dailyCommand = define({
	...
	args: {
		...
		projectAliases: {
			type: 'string',
			description: 'Comma-separated project aliases (e.g., \'gbusage=Usage Tracker,myproject=My Project\')',
			hidden: true,
		},
	},
	async run(ctx) {
