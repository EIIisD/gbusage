...
const entryPoints = [
	...globSync([
		'./node_modules/gbusage/src/*.ts',
		'!./node_modules/gbusage/src/**/*.test.ts', // Exclude test files
		'!./node_modules/gbusage/src/_*.ts', // Exclude internal files with underscore prefix
	], {
		absolute: false,
		onlyFiles: true,
	}),
	'./node_modules/gbusage/src/_consts.ts', // Include constants for documentation
];
...
export default {
	...
	entryPoints,
	tsconfig: './node_modules/gbusage/tsconfig.json',
	out: 'api',
